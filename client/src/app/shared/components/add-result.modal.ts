...
@Component({
  ...
  `],
  template: `
    <div id="add-result-modal" class="ui small modal" (keyup.enter)="(!buttonsBlocked) ? addResult() : null">
      ...
      <div class="actions">
        <div class="ui buttons">
          <button class="ui positive button" (click)="addResult()" [class.disabled]="!isResultValid() || buttonsBlocked">Add</button>
          <div class="or"></div>
