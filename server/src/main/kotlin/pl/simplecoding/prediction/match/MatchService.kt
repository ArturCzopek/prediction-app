...
class MatchService(
    ...
    fun getAllMatchesWithUserTypes(userName: String) = matchRepository.findAll()
            .map { MatchWithUserType(it, typeRepository.findByMatch_IdAndUser_login(it.id!!, userName)) }
